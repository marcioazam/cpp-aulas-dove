// =============================================================================
// AULA 02 - TIPOS MODERNOS C++11 / C++17 / C++20
// =============================================================================
//
...
{
    std::cout << "=============================================" << std::endl;
    std::cout << "   AULA 02 - TIPOS MODERNOS C++11/17/20     " << std::endl;
    ...
    // 2. DECLTYPE (C++11)
    // =========================================================================
    // decltype(expressão) retorna o TIPO de uma expressão em tempo de compilação.
    // Não avalia a expressão — só inspeciona seu tipo.
    //
    // Quando usar:
    //   - Templates onde o tipo de retorno depende dos argumentos
    //   - Declarar variável com exatamente o mesmo tipo de outra variável
    //   - Evitar repetir tipos longos que já aparecem em outro lugar
    //
    // Diferença de auto:
    //   auto x = expr;          → cria variável com tipo de expr
    //   decltype(expr) y = z;   → declara y com tipo de expr, mas inicializa com z
    // =========================================================================
    ...
    // 3. NULLPTR (C++11)
    // =========================================================================
    // nullptr é o ponteiro nulo SEGURO do C++ moderno.
    // Antes do C++11 usava-se NULL ou 0, o que causava ambiguidades.
    //
    // PROBLEMA com NULL/0:
    //   void processar(int x);
    //   void processar(char* ptr);
    //   processar(NULL);  ← ambíguo! chama qual versão?
    //
    // Com nullptr não há ambiguidade: é sempre um ponteiro nulo.
    //
    // Quando usar: SEMPRE que precisar de um ponteiro nulo. Nunca use NULL ou 0.
    // =========================================================================
    ...
    // É a alternativa segura a retornar -1, 0, ou nullptr como "sem valor".
    //
    // Antes do optional (jeito ruim):
    //   int buscarIdade(string nome) {
    //       if (!encontrado) return -1;  ← -1 é um valor válido de int!
    //   }
    //
    // Com optional (jeito correto):
    //   std::optional<int> buscarIdade(string nome) {
    //       if (!encontrado) return std::nullopt;  ← explícito e seguro
    //   }
    //
    // Quando usar:
    //   - Funções de busca que podem não encontrar nada
    //   - Parâmetros opcionais sem overloading
    //   - Substituir ponteiros usados apenas para indicar "ausência de valor"
    // =========================================================================
